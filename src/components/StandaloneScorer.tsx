...
export function StandaloneScorer() {
  ...
  const getCheckoutSuggestion = (score: number, dartsLeft: number): string => {
    ...
    const checkouts: Record<number, string> = {
      ...
      143: "T20 T17 D16", 142: "T20 T14 D20", 141: "T20 T15 D18", 140: "T20 T16 D16", 130: "T20 T10 D20",
      121: "T20 11 D25", 100: "T20 D20", 80: "T20 D10", 60: "20 D20", 40: "D20", 32: "D16", 16: "D8",
      8: "D4", 4: "D2", 2: "D1"
    };
        ...
        <div className={clsx(
          ...
          <div className={clsx(
            ...
            <div className="flex-1 text-center">
              {gameMode === 'X01' && !winner ? getCheckoutSuggestion(activePlayer === 1 ? score1 : score2, 3 - currentDarts.length) : "Good luck!"}
            </div>
...
function PlayerScore({ name, score, isActive, marks, darts, roundTotal }: {
  name: string,
  score: number,
  isActive: boolean,
