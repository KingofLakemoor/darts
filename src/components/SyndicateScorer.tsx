...
export function SyndicateScorer() {
  ...
  const getCheckoutSuggestion = (score: number, outRule: 'single' | 'double' | 'triple' = 'double'): string => {
    ...
    if (outRule === 'single') return score.toString();
    ...
    const checkouts: Record<number, string> = {
      ...
      143: "T20 T17 D16", 142: "T20 T14 D20", 141: "T20 T15 D18", 140: "T20 T16 D16", 138: "T20 T18 D12",
      137: "T19 T16 D16", 136: "T20 T20 D8", 135: "T20 T17 D12", 134: "T20 T14 D16", 133: "T20 T19 D8",
      132: "T20 T16 D12", 131: "T20 T13 D16", 130: "T20 T10 D20", 129: "T19 T16 D12", 128: "T18 T14 D16",
      127: "T20 T17 D8", 126: "T19 T19 D6", 125: "25 T20 D20", 124: "T20 14 DB", 123: "T19 T10 D18",
      122: "T18 T20 D4", 121: "T20 11 DB", 120: "T20 20 D20", 119: "T19 T10 D16", 118: "T20 18 D20",
      117: "T20 17 D20", 116: "T20 16 D20", 115: "T20 15 D20", 114: "T20 14 D20", 113: "T20 13 D20",
      112: "T20 12 D20", 111: "T20 11 D20", 110: "T20 10 D20", 109: "T19 12 D20", 108: "T19 11 D20",
      107: "T19 10 D20", 106: "T20 10 D18", 105: "T19 16 D16", 104: "T18 10 D20", 103: "T19 10 D18",
      102: "T20 10 D16", 101: "T17 10 D20", 100: "T20 D20", 99: "T19 10 D16", 98: "T20 D19", 97: "T19 D20",
      ...
      84: "T20 D12", 83: "T17 D16", 82: "T14 D20", 81: "T15 D18", 80: "T20 D10", 79: "T13 D20",
      78: "T18 D12", 77: "T15 D16", 76: "T20 D8", 75: "T17 D12", 74: "T14 D16", 73: "T19 D8",
      72: "T16 D12", 71: "T13 D16", 70: "T18 D8", 69: "T15 D12", 68: "T20 D4", 67: "T17 D8",
      66: "T10 D18", 65: "T15 D10", 64: "T16 D8", 63: "T13 D12", 62: "T10 D16", 61: "T15 D8",
      60: "20 D20", 59: "19 D20", 58: "18 D20", 57: "17 D20", 56: "16 D20", 55: "15 D20",
      54: "14 D20", 53: "13 D20", 52: "12 D20", 51: "11 D20", 49: "17 D16", 48: "16 D16",
      47: "15 D16", 46: "14 D16", 45: "13 D16", 44: "12 D16", 43: "11 D16", 42: "10 D16",
      41: "9 D16", 39: "7 D16", 38: "6 D16", 37: "5 D16", 35: "3 D16", 33: "1 D16",
      31: "15 D8", 29: "13 D8", 27: "11 D8", 25: "9 D8", 23: "7 D8", 21: "5 D8",
      19: "3 D8", 17: "1 D8", 15: "7 D4", 13: "5 D4", 11: "3 D4", 9: "1 D4",
      7: "3 D2", 5: "1 D2", 3: "1 D1",
    };
            ...
            <div className="lg:col-span-4">
              <div className="merrowed-border p-4 md:p-8 leather-bg h-full flex flex-col">
                <div className="mb-4 md:mb-8">
                  <div className="flex justify-between items-end mb-2">
                    <label className="font-rocker text-xs text-syndicate-red uppercase tracking-widest block">Current Turn</label>
                    <span className="font-mono text-xs text-steel-gray">
                      {getCheckoutSuggestion(activePlayer.score) || "GAME ON"}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-between gap-2 mb-4">
                    <div className="flex gap-1 flex-1">
                      {[0, 1, 2].map(i => {
                        const hasDart = currentDarts?.[i] !== undefined;
                        const suggestionParts = getCheckoutSuggestion(activePlayer.score)?.split(' ').filter(Boolean) || [];
                        const suggestionIndex = i - currentDarts.length;
                        const suggestionText = !hasDart && suggestionIndex >= 0 && suggestionIndex < suggestionParts.length
                        ...
                        return (
                          ...
                          >
                            {hasDart ? currentDarts[i] : <span className="opacity-40 text-syndicate-red font-light">{suggestionText}</span>}
                          </div>
                        );
                      })}
                    </div>
